### 内部排序
  ...
  |插入排序|希尔排序|O<sub>(n<sup>1.3</sup>)</sub>|O(n)|O(n<sup>2</sup>)|O(1)|不稳定|  
  |选择排序|简单选择|O<sub>(n<sup>2</sup>)</sub>|O<sub>(n<sup>2</sup>)</sub>|O<sub>(n<sup>2</sup>)</sub>|O(1)|不稳定|
  |选择排序|堆排序|O(nlog<sub>2</sub>n)|O(nlog<sub>2</sub>n)|O(nlog<sub>2</sub>n)|O(1)|不稳定|  
  |交换排序|冒泡排序|O<sub>(n<sup>2</sup>)</sub>|O(n)|O<sub>(n<sup>2</sup>)</sub>|O(1)|稳定|
  |交换排序|快速排序|O(nlog<sub>2</sub>n)|O(nlog<sub>2</sub>n)|O(n<sup>2</sup>)|O(nlog<sub>2</sub>n)|不稳定|
  |其他|归并排序|O(nlog<sub>2</sub>n)|O(nlog<sub>2</sub>n)|O(nlog<sub>2</sub>n)|O(n)|稳定|
  |其他|基数排序|O(d(r+n))|O(d(n+rd))|O(d(r+n))|O(rd+n)|稳定|
### 简单排序
  + 直接插入排序★★★
